...
3. Comparable Costs — Mandalay and Yangon:
...
5. **Total COGS Across All Branches:**  
...
![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/monthly%20profit%20%20.png)

This bar chart provides a breakdown of monthly profits for three branches — **Mandalay (Purple), Naypyitaw (Blue),** and **Yangon (Teal)** — from **January to March**.

 **1. January — Naypyitaw Leads the Pack**  

- **Naypyitaw:** $1,925 — **Highest profit** among all branches.  

- **Yangon:** $1,842 — Not far behind Naypyitaw.  

- **Mandalay:** $1,770 — Slightly lower than the others.  


**Insight:**  

- Naypyitaw’s strong start could indicate higher sales or better profit margins.  


 **2. February — Profits Decline Across the Board**  

- **Mandalay:** $1,639 — Retains the lead.  

- **Naypyitaw:** $1,568 — Drops significantly from January.  

- **Yangon:** $1,422 — **Lowest** among all branches.  

**Insight:**  
- February shows a clear **dip** for all branches, suggesting seasonal or market-related challenges.  



 **3. March — Consistent Recovery**  

- **Yangon:** $1,793 — **Highest profit** in March.  

- **Naypyitaw:** $1,771 — Close second, indicating strong recovery.  

- **Mandalay:** $1,647 — Slightly lagging behind the other two.  

**Insight:**  
- Yangon experienced the **most significant recovery**, surpassing its January and February profits.  
...
1. **Best Overall Performer:**  
   ...
   - **Naypyitaw** led in January and remained stable throughout.  

3. **Most Resilient:**  

    - **Yangon** bounced back strongly in March despite a significant drop in February.  

5. **Consistent but Modest:**  
   - **Mandalay** maintained steady performance without significant fluctuations.  





## 10 List of the product sold, their mode of payment,percentage purchase based on Gender,average quantity sold per productline and total quantity sold per productline


![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/Electronics%20accessories.jpg)

![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/Fashion%20accessories.jpg)

![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/Food%20and%20beverages.jpg)

![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/Health%20and%20beauty.jpg)

![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/Health%20and%20beauty.jpg)


![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/Home%20and%20lifestyle.jpg)

![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/Sport%20and%20travel.jpg)


### 11  list of the pages created.

![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/Dashboard%201-%20home%20page.png)

Dashboard 1 - Home page

![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/Dashboard-%20customer%20Satisfaction.png)

Dashboard 2 - Customer patronage

![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/Dashboard-%20customer%20Satisfaction.png)

Dashboard 3 - Customer Datisfaction and profit

## 12 Profit analysis

![](https://github.com/Emmanuelakanmu/MACRONAC-SALES-SUPERMAKET-DASHBOARD/blob/main/profit.png)

- **Total Profit:** $15K  

- **Time Period:** 3 months (January to March)  

 **Insights:**  

- An average of **$5K per month**, indicating moderate profitability.  

- Considering previous breakdowns, there might be room for growth, particularly by targeting underperforming months like **February**, where profits dipped across branches.  

### Recommendation


Based on the analysis of various metrics including total sales, profit, customer satisfaction, revenue by city/branch, mode of payment, and overall performance, here are **10 detailed recommendations** to enhance business outcomes:



1. **Optimize Sales Performance Across All Days of the Week**  

- Analysis of daily sales revealed that **Monday** had the highest sales, while **Friday** had the lowest. Implement promotional strategies such as **“Flash Sales Fridays”** or **“Weekend Discounts”** to boost sales on underperforming days.  

- Offer incentives like **loyalty points** or **bundle deals** to encourage more purchases on slow days.  



2. **Increase Customer Engagement Through Payment Flexibility**
  
- The mode of payment analysis showed a balanced use of **cash (34.24%), e-wallet (33.44%),** and **credit card (32.32%)**.  

- Introduce **exclusive discounts** or **cashback offers** for underutilized payment methods (e.g., **credit cards**) to maintain balance and improve transaction convenience.  



 3. **Focus on High-Performing Branches to Scale Profitability**  

- The **total revenue and cost analysis** revealed that **Naypyitaw** generated slightly higher costs but also led in total revenue.  

- Allocate additional resources and marketing budgets to high-performing branches while implementing **cost-control measures** to improve net profit margins.  


 4. **Enhance Product-Specific Satisfaction Levels**  

- In customer satisfaction across product lines, **fashion accessories** had the highest satisfaction (59), followed closely by **electronic accessories** (58).  

- To sustain and improve satisfaction, regularly gather **customer feedback** on product quality and availability.  

- For underperforming categories like **home and lifestyle**, consider offering **personalized recommendations**, better pricing, or promotions.  


 5. **Promote Membership Programs to Increase Revenue**  

- The revenue analysis by customer type indicated that **normal customers generated slightly higher revenue** than members.  

- Offer exclusive benefits for members such as **priority service**, **early access to sales**, and **personalized promotions** to drive higher engagement and spending.  



 6. **Address Profit Fluctuations to Ensure Stability**  

- Monthly profit analysis showed a decline in **February** across branches, which recovered in **March**.  

- Investigate reasons for the drop, such as **seasonality** or **customer behavior patterns**, and create contingency plans like **seasonal promotions** or **special events** during low-profit months.  


 7. **Leverage Peak Times for Targeted Promotions**  

- Sales by hour (though previously inconsistent in extraction) likely highlight peak shopping hours.  

- Run time-specific promotions such as **“Happy Hour Discounts”** during off-peak periods to maintain foot traffic and sales throughout the day.  


 8. **Encourage Digital Payment Adoption for Faster Transactions**  

- With the increasing popularity of **e-wallets** (33.44%), offer incentives such as **cashback** or **instant discounts** to encourage its use.  

- Faster transactions improve customer satisfaction and reduce wait times during peak hours.  


 9. **Balance Cost and Revenue Across Branches**  

- The total cost of goods sold analysis showed **Naypyitaw** with slightly higher costs compared to other branches.  

- Regularly review and **negotiate with suppliers** for better pricing, or optimize **inventory management** to reduce overstocking and wastage.  


10. **Implement Data-Driven Decision Making for Continuous Improvement**  

- Utilize business intelligence tools like **Power BI** to continuously monitor key performance indicators (KPIs) such as **profit margins**, **customer satisfaction**, and **payment preferences**.  
